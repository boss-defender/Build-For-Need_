...
export function AboutTab() {
  ...
  const values = [
    ...
    <div id="about-us-container" className="max-w-4xl mx-auto space-y-16 py-6 font-sans">
      ...
      {/* Process Flow */}
      <div className="bg-white/75 dark:bg-slate-900/60 backdrop-blur-md rounded-2xl border border-slate-200/40 dark:border-slate-800/80 p-8 shadow-xs">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-slate-50 dark:bg-slate-900/90 text-slate-800 dark:text-white rounded-3xl p-8 space-y-4 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-md transition-colors duration-300">
        ...
        <div className="bg-indigo-50/50 dark:bg-indigo-950/40 text-indigo-950 dark:text-white rounded-3xl p-8 space-y-4 border border-indigo-100 dark:border-indigo-900/50 shadow-sm dark:shadow-md transition-colors duration-300">
          <span className="text-indigo-600 dark:text-indigo-400 text-xs font-mono tracking-widest uppercase font-bold">For Beginner Developers</span>
          <h3 className="text-2xl font-bold font-display text-indigo-950 dark:text-white">Break Out of Tutorial Hell</h3>
          <p className="text-indigo-900/80 dark:text-indigo-200 text-xs leading-relaxed font-sans">
