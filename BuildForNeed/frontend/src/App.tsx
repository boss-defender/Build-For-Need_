  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans flex flex-col transition-colors duration-300">
      ...
      <main
        ...
        className="flex-1 w-full mx-auto px-[clamp(0.5rem,3vw,1.5rem)] py-5 sm:px-6 md:px-8 lg:px-[clamp(1.5rem,4vw,3rem)] lg:py-[clamp(1.5rem,4vh,3.5rem)] transition-all ease-out duration-300 flex flex-col overflow-x-hidden"
        ...
        {authLoading ? (
          ...
          >
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 font-sans">
              ...
              <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-xs hover:shadow-md transition-all duration-300 relative overflow-hidden">
                {authMode === "signup" ? (
                  <div
                    key="signup-view"
                    ...
                    <form onSubmit={handleSignupSubmit} className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-2.5 text-xs sm:text-sm border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 transition-all bg-slate-50/50 dark:bg-slate-950/40"
                        />
                      </div>
          ...
          <div id="authenticated-main-dashboard">
            {activeTab === "about" ? (
              <AboutTab />
            ) : activeTab === "faq" ? (
              <FaqTab />
              ...
              <div className="space-y-6 @container w-full">
                <AnimatePresence mode="wait">
                  {showIntroSequence ? (
                    ...
                    <motion.div
                      ...
                      className="grid grid-cols-1 lg:grid-cols-12 gap-[clamp(1.2rem,2.5vw,2.5rem)] items-start w-full"
                    >
                      {/* Left Sidebar Pane: Categories & Stats Spotlight */}
                      <div className="lg:col-span-4 xl:col-span-3 space-y-6">
                        {/* Category Filter list with high fidelity liquid glass styling */}
                        <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-md rounded-2xl border border-slate-200/50 dark:border-slate-850 p-5 shadow-xs">
                          ...
                          <ul className="space-y-1.5">
                              ...
                              <button
                                ...
                                className={`w-full text-left px-3 py-2 rounded-lg text-xs font-semibold flex items-center justify-between transition-all cursor-pointer ${
                                  activeCategory === "all" && !showBookmarksOnly && activeTab === "feed"
                                    ...
                                    : "text-slate-600 dark:text-slate-450 hover:bg-slate-100 dark:hover:bg-slate-850 hover:text-slate-900 dark:hover:text-slate-100"
                                }`}
                              >
                                ...
                                <button
                                  ...
                                  className={`w-full text-left px-3 py-2 rounded-lg text-xs font-semibold flex items-center justify-between transition-all cursor-pointer ${
                                    activeCategory === cat && !showBookmarksOnly && activeTab === "feed"
                                      ? "bg-indigo-600 dark:bg-indigo-550 text-white font-bold"
                                      : "text-slate-600 dark:text-slate-450 hover:bg-slate-100 dark:hover:bg-slate-850 hover:text-slate-900 dark:hover:text-slate-100"
                                  }`}
                                >
                                  <span>{cat}</span>
                            ...
                            {/* Navigation Links inside Browse Categories list */}
                            <li>
                              <button
                                onClick={() => {
                                  setActiveTab("about");
                            ...
                            <li>
                              <button
                                ...
                                className={`w-full text-left px-3 py-2 rounded-lg text-xs font-semibold flex items-center justify-between transition-all cursor-pointer ${
                                  activeTab === "donate"
                                    ? "bg-rose-600 dark:bg-rose-600 text-white font-bold"
                          ...
                          {/* Developer Bookmarks Quick Filter */}
                          {currentUser.rolePreference ===
                            UserRole.DEVELOPER && (
                              ...
                              <button
                                ...
                                className={`w-full text-left px-3 py-2 rounded-lg text-xs font-bold flex items-center gap-2 transition-all ${
                                  showBookmarksOnly
                                    ...
                                    : "text-amber-600 dark:text-amber-500 hover:bg-amber-50/50 dark:hover:bg-amber-950/20"
                                }`}
                              >
                                <Bookmark
                                  className={`w-4 h-4 ${showBookmarksOnly ? "fill-white" : ""}`}
                                />
                                <span>Show Saved Bookmarks</span>
                      ...
                      <div className="lg:col-span-8 xl:col-span-9 space-y-6">
                        {/* Toolbar Search Header with sleek liquid glass container */}
                        <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-md p-4 rounded-2xl border border-slate-200/40 dark:border-slate-800 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
                          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:max-w-2xl">
                            <div className="relative flex-1">
                              <input
                                ...
                                className="w-full text-xs pl-8 pr-12 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 bg-slate-50/50 dark:bg-slate-950/50 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-medium"
                              />
                            ...
                            {/* Post Sorting Selector */}
                            <div className="flex items-center gap-1.5 bg-slate-100/90 dark:bg-slate-950 p-1 rounded-xl border border-slate-250 dark:border-slate-800 shrink-0">
                              <span className="text-[10px] uppercase font-mono font-extrabold text-slate-400 dark:text-slate-500 px-1.5">
                                Sort:
                              </span>
                              <select
                                value={postSortOrder}
                          ...
                          <div className="flex items-center gap-3 shrink-0 w-full md:w-auto justify-end">
                            {/* Create Post Action Button (Visible to Sharer) */}
                            {currentUser.rolePreference ===
                              UserRole.PROBLEM_SHARER && (
                              <button
                                onClick={handleOpenCreateModal}
                                className="w-full md:w-auto px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl uppercase tracking-wider flex items-center justify-center gap-2 shadow-xs transition-all hover:translate-y-[-1px]"
                              >
                                <Plus className="w-4 h-4" />
                                <span>Share New Problem</span>
                              </button>
                            )}

                            {/* Developer Info Banner info */}
                            {currentUser.rolePreference ===
                              UserRole.DEVELOPER && (
                              <div className="text-[11px] text-slate-400 font-sans italic bg-slate-50 border border-slate-100 rounded-lg px-3 py-1.5 flex items-center gap-1.5">
                                <Info className="w-3.5 h-3.5 text-indigo-500 shrink-0" />
                                <span>
                                  Filter categories on left sidebar. Highlighted
                                  favorites saved below!
                                </span>
                              </div>
                            )}
                          </div>
                        ...
                        {loadingPosts ? (
                          ...
                          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-12 text-center space-y-4 shadow-xs">
                            <div className="h-12 w-12 bg-slate-50 dark:bg-slate-950 hover:bg-indigo-50 dark:hover:bg-indigo-950 text-slate-400 dark:text-slate-550 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-full flex items-center justify-center mx-auto transition-colors">
                            ...
                            {filteredPosts.map((post) => {
                              ...
                              return (
                                <motion.div
                                  ...
                                  className="bg-white/75 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/40 dark:border-slate-800/80 rounded-2xl shadow-xs overflow-hidden hover:shadow-md hover:border-indigo-500/30 dark:hover:border-indigo-500/30 transition-all duration-300 ease-out md:hover:scale-[1.015] md:hover:-translate-y-0.5 md:active:scale-[0.99] active:scale-[0.985] select-none touch-manipulation active:bg-slate-100 dark:active:bg-slate-950/40"
                                >
                                  <div className="p-6 space-y-4">
                                          ...
                                          <div className="flex items-center gap-1.5">
                                            ...
                                            {deleteConfirmPostId === post.id ? (
                                              ...
                                              <button
                                                ...
                                                className="p-2 rounded-xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100/40 dark:border-slate-850 text-slate-400 hover:text-red-500 dark:hover:text-red-400 hover:bg-rose-50 dark:hover:bg-rose-955/30 hover:border-rose-100 dark:hover:border-rose-900/50 transition-all cursor-pointer"
                                                title="Delete Post"
                                              >
                                    ...
                                    <div className="space-y-2">
                                      <h3 className="text-lg font-bold text-slate-950 dark:text-slate-50 font-sans group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                                        {post.title}
                                      </h3>
                                      <p className="text-slate-600 dark:text-slate-350 text-xs sm:text-sm leading-relaxed whitespace-pre-wrap">
                                        {post.description}
                                      </p>
                                    </div>
                                  ...
                                  {isCommentsExpanded && (
                                    <div className="bg-slate-50 dark:bg-slate-900/40 border-t border-slate-100 dark:border-slate-800 p-6 space-y-6">
                                                      ...
                                                      >
                                                        {isEditingThisComment ? (
                                                          ...
                                                          <>
                                                              ...
                                                              <div className="flex items-center gap-1.5">
                                                                ...
                                                                {ratingBoxVisible && (
                                                                  <motion.div
                                                                    ...
                                                                    initial="hidden"
                                                                    animate="visible"
                                                                    className={`inline-flex items-center gap-2.5 px-3 py-1.5 rounded-xl border transition-all ${
                                                                      canUserRate
                                                                    ...
                                                                    {canUserRate &&
                                                                      ...
                                                                      (comm.ratings?.find(
                                                                        ...
                                                                        <button
                                                                          ...
                                                                          className="ml-2 cursor-pointer rounded-lg bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-900/50 border border-rose-200/50 dark:border-rose-900/40 px-2 py-1 text-[10px] font-bold text-rose-600 dark:text-rose-450 font-sans transition-all"
                                                                          title="Clear my rating"
                                                                        >
                                                                          Cancel Rating
                                                                        </button>
                                                                      )}
                                                                    <span className="ml-1 text-[8px] font-bold text-slate-400 dark:text-slate-500">
                                                                      (
                                                                      {comm.ratings?.length ||
                                                                        (comm.rating
                                                                          ? 1
                                                            ...
                                                            {/* Content block */}
                                                            <div className="text-xs text-slate-700 dark:text-slate-300 whitespace-pre-wrap leading-relaxed py-1">
                                                              {comm.content}
                                                            </div>
                                                            ...
                                                            {isReplyingThisComment ? (
                                                              ...
                                                              >
                                                                ...
                                                                >
                                                                  <p
                                                                    className={`italic ${comm.reply?.replyContent ? "text-slate-700 dark:text-slate-300 font-medium" : "text-slate-400/80 dark:text-slate-500 font-normal"}`}
                                                                  >
                                                                    “
                                                                    {comm.reply
                                                                      ?.replyContent ||
                                              ...
                                              >
                                                ...
                                                <div className="space-y-1">
                                                  ...
                                                  <textarea
                                                    ...
                                                    className="w-full p-3 text-xs border border-slate-200 dark:border-slate-705 bg-slate-50/55 dark:bg-slate-950/65 rounded-xl text-slate-900 dark:text-slate-105 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 font-mono"
                                                  />
                                                </div>
                                                ...
                                                <div className="space-y-1">
                                                  ...
                                                  <div className="relative">
                                                    ...
                                                    <input
                                                      ...
                                                      className="w-full pl-9 pr-3 py-2.5 text-xs border border-slate-200 dark:border-slate-705 bg-slate-50/55 dark:bg-slate-950/65 rounded-xl text-slate-900 dark:text-slate-105 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 font-mono"
                                                    />
                                                  </div>
                                                </div>
                                      ...
                                      <div className="hidden md:block bg-white/80 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/40 dark:border-slate-800/80 p-5 rounded-2xl space-y-4 shadow-xs">
                                        <div className="flex items-center justify-between gap-4">
                                          <div>
                                        ...
                                        >
                                          <div>
                                            <textarea
                                              ...
                                              className="w-full p-3 text-xs border border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-mono"
                                            />
                                          </div>
                                          ...
                                          <div>
                                            ...
                                            <div className="relative">
                                              ...
                                              <input
                                                ...
                                                className="w-full pl-9 pr-3 py-2.5 text-xs border border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 font-mono transition-all"
                                              />
                                            </div>
                                          </div>
                                          ...
                                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-1">
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                              <div className="flex items-center gap-1.5">
                                                <span className="text-[11px] text-slate-400 font-bold uppercase tracking-wide shrink-0">
                                                  Comment Mode:
                                                </span>
                                                <select
                                                  value={commentVisibility}
