  ...
  return (
    <div id="donate-platform-view" className="max-w-4xl mx-auto space-y-12 py-6 font-sans">
      ...
      <div className="grid md:grid-cols-12 gap-8 items-start">
        ...
        <div 
          id="qr-donation-card" 
          className="md:col-span-6 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-md flex flex-col items-center justify-center w-full relative"
        >
        ...
        <div className="md:col-span-6 space-y-6">
          ...
          <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-md rounded-2xl border border-slate-200/50 dark:border-slate-800/80 p-6 shadow-xs space-y-4">
