            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center items-center py-6 gap-8 w-full max-w-sm mx-auto shrink-0 select-none">
                ...
                <div className="w-full flex flex-col gap-6 border-t border-slate-200 dark:border-slate-800/60 pt-6 max-w-sm">
                  ...
                  <div className="w-full bg-slate-100/60 dark:bg-slate-900/45 rounded-2xl p-4 border border-slate-205 dark:border-slate-800 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className={`text-left px-2.5 py-2 rounded-xl text-xs font-bold truncate transition-colors cursor-pointer ${
                          activeCategory === "all" && !showBookmarksOnly && activeTab === "feed"
                            ? "bg-indigo-600 text-white shadow-xs"
                            : "bg-white dark:bg-slate-850 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200/50 dark:border-slate-750"
                        }`}
                      >
                        All Problems
                      </button>
